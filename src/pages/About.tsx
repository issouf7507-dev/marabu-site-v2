...
import imgServices from "../assets/imgs/services/services-marabu.webp";
import marahead from "../assets/imgs/marabu-services.webp";
import imgConseilTile from "../assets/imgs/conseils/conseil-1.webp";
import imgInterTile from "../assets/imgs/intermediation/intermediation-1.webp";
...
export default function About() {
  ...
  const promise = t("about.values.promise", { returnObjects: true }) as {
    label: string;
    text: string;
  };
  ...
  // Une image distincte par service : l'ancienne version réutilisait la photo
  // du fondateur pour Conseil ET Intermédiation (doublon signalé en revue).
  const serviceImages = [imgConseilTile, imgServices, imgInterTile];
    ...
    <PageTransition>
      ...
      <div className="min-h-screen bg-[#ecede3]">
        ...
        <main id="main-content">
          {/* ══ HERO IMAGE ══ */}
          <section className="relative w-full h-[40vh] min-h-[280px] md:h-[60vh] md:min-h-[400px]">
            <img
              src={bgLoader}
              alt=""
          ...
          >
            <FadeIn>
              <h1 className="text-[clamp(2.5rem,6vw,5.5rem)] font-light leading-tight text-[#1d454c] max-w-4xl">
                {t("about.hero.title1")}
                <br />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-16 items-start">
              ...
              <div>
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="space-y-5">
                      <FadeIn delay={0.1}>
                        <h2 className="text-2xl font-light leading-snug text-[#1d454c]">
                          {t("about.who.heading")}
                        </h2>
                      </FadeIn>
                      <FadeIn delay={0.15}>
                ...
                >
                  ...
                  <div className="grid md:grid-cols-3 gap-10 mb-12">
                    {mvp.map((item, i) => (
                      <FadeIn key={i} delay={i * 0.08}>
                        <div>
                          <p className="text-xs uppercase tracking-[0.25em] text-[#3f6b3f] mb-3">
                            {item.label}
                          </p>
                  ...
                  {/* NOTRE PROMESSE — déplacée hors du trio Mission/Vision/Valeurs,
                    en clôture de la section comme un engagement mis en avant. */}
                  <FadeIn delay={0.1}>
                    <div
                    ...
                    >
                      ...
                      <p className="text-[#ecede3]/85 text-lg font-light leading-relaxed max-w-2xl">
                        {promise.text}
                      </p>
                    </div>
                  </FadeIn>
                ...
                <section id="info" className="scroll-mt-28 py-20">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-x-8 gap-y-10 items-start">
                    {infoItems.map((item, i) => (
                      <FadeIn key={i} delay={i * 0.06}>
                        <div>
                          <p className="text-xs uppercase tracking-[0.2em] text-black/65 mb-1">
                            {item.label}
                          </p>
              ...
              <aside className="hidden lg:block self-stretch">
                <div className="sticky top-28">
                  ...
                  <div className="mt-10">
                    <Link
                      to="/contact"
                      className="block text-center text-xs uppercase tracking-[0.2em] px-6 py-3 transition-all duration-300 text-white whitespace-nowrap"
                      style={{ backgroundColor: "#1d454c" }}
                    >
                      {t("about.sidebarCta")}
                    </Link>
          ...
          <section style={{ borderTop: "1px solid #f0f0f0" }}>
            <div className="maxwidth  mx-auto px-6 lg:px-12 py-6 flex items-center justify-between">
              ...
              <a
                href="/#services"
                className="text-xs uppercase tracking-[0.2em] text-[#3f6b3f] hover:underline"
              >
                {t("common.seeAll")}
              </a>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <FadeIn delay={0.1}>
                  <div className="space-y-6">
                    ...
                    <Link
                      to="/contact"
                      className="inline-block text-xs uppercase tracking-[0.2em] px-10 py-4 transition-all duration-300 text-[#1d454c] font-medium whitespace-nowrap"
                      style={{ backgroundColor: "#ecede3" }}
                    >
                      Nous écrire
                    </Link>
