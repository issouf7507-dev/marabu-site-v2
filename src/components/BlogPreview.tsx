...
const posts = [
  {
    ...
    title: 'L\'Afrique au cœur des nouvelles stratégies mondiales d\'investissement',
    excerpt:
  ...
  },
  {
    ...
    title: 'Soft power et diplomatie privée : comment les entreprises influencent les politiques publiques',
    excerpt:
  ...
  },
  {
    ...
    title: 'Former pour transformer : l\'impact du capacity building sur la performance des organisations',
    excerpt:
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-4">
        <span
          ...
          style={{ backgroundColor: post.categoryColor.bg, color: post.categoryColor.text }}
        >
          {post.category}
        </span>
      ...
      <p className="text-sm text-black/55 leading-relaxed mb-6">{post.excerpt}</p>
...
function ArticleSmall({ post, delay }: { post: typeof posts[0]; delay: number }) {
  return (
    <motion.article
  ...
  return (
    <section id="blog" className="py-24 max-w-[1800px] mx-auto px-6">
      ...
      <div className="grid grid-cols-[1fr_2fr] gap-24 items-end mb-16">
        <FadeIn>
          <p className="text-xs uppercase tracking-[0.25em] text-black/40">Insights</p>
        </FadeIn>
        <FadeIn delay={0.1}>
          <div className="flex items-end justify-between">
            <h2 className="text-4xl font-light leading-snug">
              Perspectives &<br />analyses.
            </h2>
            <a
              href="#blog"
              className="text-xs uppercase tracking-[0.2em] text-black/40 hover:text-black transition-colors duration-300 flex items-center gap-2 pb-1"
            >
