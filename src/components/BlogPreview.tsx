  ...
  return (
    <Link to={`/actualites/${article.id}`} className="block">
      ...
      >
        ...
        <span className="text-xs uppercase tracking-[0.2em] text-black/60 flex items-center gap-2 group-hover:gap-4 transition-all duration-300">
    ...
    <Link to={`/actualites/${article.id}`} className="block">
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <span className="text-xs text-black/60 flex items-center gap-1.5 group-hover:gap-3 transition-all duration-300 mt-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-[3fr_2fr] gap-8 md:gap-16 items-start animate-pulse">
      ...
      <div className="flex flex-col gap-8 pt-2">
        {[0, 1].map((i) => (
          <div
            key={i}
            className="flex gap-6 border-b border-black/10 pb-8 last:border-none"
          >
  ...
  return (
    <section id="blog" className="py-24 max-w-[1800px] mx-auto px-6">
      <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-4 md:gap-24 items-end mb-10 md:mb-16">
        ...
        <FadeIn delay={0.1}>
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
            ...
            <Link
              to="/actualites"
              className="text-xs uppercase tracking-[0.2em] text-gray-600 hover:text-black transition-colors duration-300 flex items-center gap-2 pb-1"
            >
      ...
      {!isLoading && preview.length === 0 && (
        <p className="text-sm text-black/65 text-center py-16 uppercase tracking-widest">
