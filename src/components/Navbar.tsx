...
export default function Navbar() {
  ...
  const textColor = isLight ? "#eff3d4" : "#1d454c";
  const borderColor = isLight ? "#eff3d430" : "#1d454c25";
  const langActiveBg = isLight ? "#eff3d420" : "#1d454c";
  const langActiveText = isLight ? "#eff3d4" : "#eff3d4";
  const langBorder = isLight ? "#eff3d440" : "#1d454c";

  return (
    <motion.header
      className="fixed top-0 left-0 right-0 w-full z-50 transition-all duration-300"
      style={{
        backgroundColor: scrolled ? "#eff3d4" : "transparent",
      ...
      >
        ...
        <div className="flex flex-col items-end gap-2 transition-all duration-300">
          ...
          <div
            ...
            style={{ maxHeight: scrolled ? 0 : 40, opacity: scrolled ? 0 : 1, marginBottom: scrolled ? 0 : undefined }}
          >
            {languages.map((l) => (
              <button
                key={l.code}
            ...
            <ul className="flex items-center gap-5">
              ...
              <li>
                <Link
                  ...
                  style={{
                    color: isLight ? "#1d454c" : "#eff3d4",
                    backgroundColor: isLight ? "#eff3d4" : "#1d454c",
                    padding: "6px 18px",
                    opacity: 0.9,
                    textDecoration: "none",
                  }}
